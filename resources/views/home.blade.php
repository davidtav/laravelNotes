            ...
            <div class="col">
                ...
                <div class="row mb-3 align-items-center">
                    ...
                    <div class="col text-center">
                        Aprendendo <span class="text-warning">Laravel</span> com projetos!
                    </div>
                    <div class="col">
                ...
                <div class="row mt-5">
                    <div class="col text-center">
                        <p class="display-6 mb-5 text-secondary opacity-50">Você não possui notas disponiveis!</p>
                        ...
                        <div class="card p-4">
                            <div class="row">
                                <div class="col">
                                    ...
                                    <small class="text-secondary"><span class="opacity-75 me-2">Criado em:</span><strong>00/00/0000 00:00:00</strong></small>
                                </div>
